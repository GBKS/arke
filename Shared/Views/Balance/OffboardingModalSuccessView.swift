        ...
        VStack(spacing: 25) {
            ...
            VStack(spacing: 15) {
                VStack(spacing: 8) {
                    ...
                    Text(String(localized: "balance_transfer_savings_progress", defaultValue: "Your coins are being moved to your savings balance. This may take a moment to complete."))
                        .font(.title3)
